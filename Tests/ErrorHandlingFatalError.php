...
/*
 * ErrorHandlingFatalError
 * To test fatal errors on Minion Error Handling 
 * Error goes on c(). Just uncoment the proper lines to test at other levels
 * They are marked by //Fatal error on ...
 *
 * @author ProceduralMan <proceduralman@gmail.com>
 * @copyright 2021
 * @version 1.0 initial version
 * @package Minion Library
 * @todo revisar porqué en b() y c() entran retornos de carro. Cambiar separador para testear
 */
